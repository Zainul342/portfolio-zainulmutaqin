  ...
  return [
    {
      id: 'nav-boot',
      label: 'go to boot',
      description: 'Layer 00 (Hero system)',
      category: 'navigate',
      icon: <Hash size={14} />,
    ...
    },
    {
      id: 'nav-origin',
      label: 'go to origin',
      description: 'Layer 01 (About & Personal Atlas)',
      category: 'navigate',
      icon: <Hash size={14} />,
    ...
    },
    {
      id: 'nav-terrain',
      label: 'go to terrain',
      description: 'Layer 02 (Professional timeline)',
      category: 'navigate',
      icon: <Hash size={14} />,
    ...
    {
      id: 'nav-fieldwork',
      label: 'go to fieldwork',
      description: 'Layer 03 (Project field notes)',
      category: 'navigate',
      icon: <Hash size={14} />,
    ...
    },
    {
      id: 'nav-signal',
      label: 'go to signal',
      description: 'Layer 04 (Contact channels)',
      category: 'navigate',
      icon: <Hash size={14} />,
