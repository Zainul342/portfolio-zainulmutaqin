...
import { MapPin, Coffee, Terminal, Cpu, Clock, Heart, Award, Compass } from 'lucide-react'
        ...
        <Reveal delay={0.05} direction="up">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[minmax(140px,auto)]">
            ...
            >
              <div className="spotlight-card-content flex flex-col justify-between h-full w-full">
                <div className="flex items-center justify-between">
                  <Compass size={16} style={{ color: '#94e2d5' }} />
                  <span className="font-mono text-[9px] text-[#6c7086]">~/portfolio-tree</span>
                </div>
                <div className="font-mono text-[10px] my-3 leading-tight space-y-0.5" style={{ color: '#cdd6f4' }}>
                  <div>.</div>
                  <div>├── <span className="text-[#cba6f7]">profile</span>/ (about)</div>
                  <div>├── <span className="text-[#89b4fa]">experience</span>/ (history)</div>
