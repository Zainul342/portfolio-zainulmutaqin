...
function NeovimBuffer({
  ...
  return (
    <div
      ...
      className={`relative rounded-none border overflow-hidden flex flex-col transition-all duration-200 select-none bg-black/45 backdrop-blur-md min-h-[170px] ${className}`}
      style={{
    ...
    >
      ...
      <div className="flex items-center justify-between font-mono text-xs bg-[#0f0f14] text-[#a6adc8] border-t border-white/5 h-6 select-none">
        <div className="flex items-center h-full">
          ...
          {/* Filename status */}
          <div className="px-2 text-neutral-400 hidden sm:block max-w-[100px] truncate">
            {filename}
          </div>
        </div>
      ...
      <div className="relative max-w-5xl mx-auto">
        <Reveal delay={0.05} direction="up">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[minmax(150px,auto)]">
              ...
              <div className="flex flex-col justify-between h-full">
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-mono text-xs text-neutral-400">Jakarta, Indonesia</span>
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-[#cdd6f4]">
                    Hey, I&rsquo;m <span style={{ color: '#cba6f7' }}>Zainul Mutaqin</span>.
                  </h3>
                  <p className="text-xs leading-relaxed text-neutral-200 mb-3" style={{ lineHeight: 1.6 }}>
                  ...
                  <p className="text-xs leading-relaxed text-neutral-200" style={{ lineHeight: 1.6 }}>
                ...
                <div className="flex items-center gap-2 mt-4 pt-3 border-t border-white/5 font-mono text-xs text-neutral-400">
            ...
            >
              <div className="font-mono text-xs flex-grow flex flex-col justify-between h-full">
                <div>
                  <div className="mb-3 text-[#cba6f7] select-none">~/learning</div>
                  {LEARNING_ITEMS.map((item, i) => (
                    <div key={item.label} className="flex items-start gap-1.5 mb-2.5 text-neutral-200">
                ...
                <div className="mt-4 pt-3 border-t border-white/5 select-none text-neutral-400">
                  <div className="mb-2 text-xs text-neutral-400">$ cat currently_learning</div>
                  <div className="flex flex-wrap gap-1">
                    {LEARNING_BADGES.map((badge) => (
                      <span
                        key={badge.label}
                        className="px-1.5 py-0.5 rounded-[2px] text-xs font-mono font-medium bg-white/[0.02] border border-white/5"
            ...
            >
              <div className="flex flex-col justify-between h-full font-mono text-xs">
                <div className="text-neutral-400 uppercase tracking-wider">GMT+7 TIME</div>
                <div>
                  <div className="text-lg font-bold text-[#cdd6f4] tracking-tight">{time || '12:00:00'}</div>
                  <div className="text-xs text-neutral-200 mt-0.5">Jakarta, ID</div>
                </div>
                <div className="text-neutral-400 border-t border-white/5 pt-2">
                  6.2088° S, 106.8456° E
                </div>
              </div>
            </NeovimBuffer>
            ...
            >
              <div className="flex flex-col justify-between h-full text-xs">
                ...
                <div>
                  ...
                  <div className="text-xs text-neutral-200 font-mono mt-0.5">EndeavourOS (bspwm)</div>
                </div>
                <div className="font-mono text-neutral-400 border-t border-white/5 pt-2">
                  Ghostty + Neovim Zen
                </div>
              </div>
            </NeovimBuffer>
            ...
            >
              <div className="flex flex-col justify-between h-full text-xs">
                <div className="font-mono text-neutral-400 uppercase tracking-wider mb-2">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {SKILL_GROUPS[0].skills.map((skill) => (
                    <span
                      key={skill.label}
                      className="px-1.5 py-0.5 rounded-[2px] text-xs font-mono text-[#a6adc8] border border-white/5 bg-white/[0.01]"
                    >
                      {skill.label}
                    </span>
                  ))}
            ...
            >
              <div className="flex flex-col justify-between h-full text-xs">
                ...
                <div className="font-mono text-xs my-1 leading-tight space-y-0.5" style={{ color: '#cdd6f4' }}>
                  <div>.</div>
